...
RUNTIME = ("hermes_state_inspector.py", "hermes_cli/observability/native_inspector.py", "gateway/pwa_inspector_facts.py", "hermes_cli/observability/__init__.py", "plugins/observability/langfuse/__init__.py", "gateway/permission_grants.py", "plugins/platforms/telegram/grants.py", "hermes_cli/commands.py", "gateway/native_clarification.py", "hermes_state_clarifications.py", "hermes_state_controls.py", "gateway/native_redirect.py", "agent/native_execution_context.py", "agent/auxiliary_client.py", "agent/title_generator.py", "gateway/native_cancellation.py",
           ...
           "gateway/pwa_workload.py", "gateway/config.py", "hermes_cli/config_defaults.py",
...
NEW_RUNTIME = ("hermes_state_inspector.py", "hermes_cli/observability/native_inspector.py", "gateway/pwa_inspector_facts.py", "gateway/permission_grants.py", "plugins/platforms/telegram/grants.py", "gateway/native_clarification.py", "hermes_state_clarifications.py", "hermes_state_controls.py", "gateway/native_redirect.py", "agent/native_execution_context.py", "gateway/native_cancellation.py",
               "hermes_state_cancellation.py", "plugins/platforms/a2a/cancellation.py",
               ...
               "gateway/pwa_inspector.py", "gateway/native_inspector_payload.py",
           "gateway/pwa_history_scan.py", "gateway/pwa_images.py", "gateway/pwa_image_http.py", "gateway/pwa_image_policy.py",
               "gateway/pwa_workload.py", "gateway/native_events.py", "hermes_state_events.py",
